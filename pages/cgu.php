...
<html lang="fr-FR">
    ...
    <body>
        ...
        <section>
            ...
            <p class="paragraphe">Le site Nolark est édité par :</p>
            <p class="paragraphe"><strong>Amélia PILOU</strong></p>
            <p class="paragraphe">domiciliée à l'adresse suivante&nbsp;:&nbsp;Avenue Winston Churchill, 83000 Toulon, et immatriculé au numéro suivant&nbsp;:&nbsp;RCS 123456789</p>
            <p class="paragraphe">Téléphone&nbsp;:&nbsp;0102030405</p>
            <p class="paragraphe">Adresse e-mail&nbsp;:&nbsp;contact@nolark.gil83.fr</p>
            <p class="paragraphe">ci-après "<i>l'Éditeur</i>"</p>
            <p class="sousTitre"><b>B. Directeur de publication</b></p>
            <p class="paragraphe">Le Directeur de publication est :</p>
            <p class="paragraphe"><strong>Mario TIDUCA</strong></p>
            <p class="paragraphe">Adresse e-mail de contact&nbsp;:&nbsp;directpub@nolark.gil83.fr</p>
            <p class="paragraphe">ci-après "<i>le Directeur de publication</i>"</p>
            <p class="sousTitre"><b>C. Hébergeur du site</b></p>
            <p class="paragraphe">Le site Nolark est hébergé par :</p>
            <p class="paragraphe"><strong>OVH SAS</strong></p>
            <p class="paragraphe">dont le siège est situé à l'adresse suivante&nbsp;:&nbsp;2 rue Kellermann - BP 80157, 59100 Roubaix</p>
            <p class="paragraphe">Téléphone&nbsp;:&nbsp;0320200958</p>
            <p class="paragraphe">Adresse e-mail&nbsp;:&nbsp;contact@ovh.net</p>
            <p class="paragraphe">ci-après "<i>l'Hébergeur</i>"</p>
            <p  class="sousTitre"><b>D. Utilisateurs</b></p>
            <p class="paragraphe">Sont considérés comme utilisateurs tous les internautes qui naviguent, lisent, visionnent et utilisent le site Nolark.</p>
            <p class="paragraphe">ci-après les "<i>Utilisateurs</i>"</p>
            <p class="titresArticles">Article 2 - Confidentialité</p>
            <p class="sousTitre"><b>A. Données collectées et traitées</b></p>
            <p class="paragraphe">Conformément aux dispositions de l'article 5 du Règlement européen 2016/679, la collecte et le traitement des données des utilisateurs du site respectent les principes suivants :</p>
            <ul>
